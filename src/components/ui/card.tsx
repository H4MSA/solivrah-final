...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border bg-[#1A1A1A] border-[#333333] text-card-foreground shadow-lg transition-all duration-300 p-5 mb-5",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center justify-between p-2 pt-3", className)}
    {...props}
  />
))
