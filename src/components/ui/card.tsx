...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border bg-black/80 border-[#333333] text-card-foreground shadow-md transition-all duration-300 p-4 mb-4",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center justify-between p-1 pt-2", className)}
    {...props}
  />
))
