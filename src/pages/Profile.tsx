...
import { Camera, Settings, Edit, LogOut, UserCircle, Award, ChevronRight, Send } from 'lucide-react';
...
const Profile = () => {
  ...
  return (
    <motion.div 
      className="pb-20 px-4 pt-2"
      initial="hidden"
      animate="visible"
      variants={containerVariants}
    >
      <motion.div variants={itemVariants} className="mb-6">
        <GlassCard variant="ultra-glass" className="relative h-48 overflow-hidden rounded-xl">
          ...
          <div className="absolute -bottom-12 left-4 h-24 w-24 rounded-full border-4 border-[#121212] shadow-xl">
